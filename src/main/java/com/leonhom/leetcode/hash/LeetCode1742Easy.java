...
/**
 * 你在一家生产小球的玩具厂工作，有 n 个小球，编号从 lowLimit 开始，到 highLimit 结束（包括 lowLimit 和highLimit ，即n == highLimit - lowLimit + 1）。
...
public class LeetCode1742Easy {
    ...
    public int countBalls(int lowLimit, int highLimit) {
        ...
        for (int i = lowLimit; i <= highLimit; i++) {
            ...
            result = Math.max(result, countMap.get(temp));
        }
        return result;
    }
}
